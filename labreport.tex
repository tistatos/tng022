...
The time constant of a system determines how fast it reacts to changes. The time constant can be retrieved as the time when the system reaches 63\% from the step response's final value.
